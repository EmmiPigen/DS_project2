...
class VectorMessage:
  ...
  def to_dict(self):
    ...
    # Return the raw vector clock list here. The pack->hex encoding is
    # performed by the sender to centralize binary serialization logic
    # (so Lamport vs Vector send behavior can be handled in one place).
    return {
